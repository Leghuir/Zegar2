...
//	@NotNull
	...
	public static WatchEntity produceMoneta(Long numerKatalogowy, String krajPochodzenia, Long nominal, String waluta, String opis,
			Date dataNabycia, BigDecimal cenaNabycia, Status status) {
		WatchEntity m = new WatchEntity();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WatchEntity other = (WatchEntity) obj;
		if (opis == null) {
			if (other.opis != null)
				return false;
